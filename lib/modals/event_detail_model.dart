...
class EventDetailModal {
  ...
  EventDetailModal({this.data, this.availability, this.status});
...
class Data {
  ...
  List<ExtraPriceEvent>? extraPrice;
  int? passenger;
  String? gear;
  int? baggage;
  int? door;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['ticket_types'] != null) {
      ...
      json['ticket_types'].forEach((v) {
        ticketTypes!.add(TicketType.fromJson(v)); // Deserialize ticket types
      });
    }
    mapLat = json['map_lat'];
    mapLng = json['map_lng'];
    ...
    if (json['extra_price'] != null) {
      extraPrice = <ExtraPriceEvent>[];
      json['extra_price'].forEach((v) {
        extraPrice!.add(ExtraPriceEvent.fromJson(v));
      });
    }
...
class ExtraPriceEvent {
  String? name;
  String? price;
  String? type;
  bool? valueType;

  ExtraPriceEvent({this.name, this.price, this.type, this.valueType = false});

  ExtraPriceEvent.fromJson(Map<String, dynamic> json) {
    name = json['name'];
    price = json['price'];
