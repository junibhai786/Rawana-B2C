...
//
//     final allFlightVendorModel = allFlightVendorModelFromJson(jsonString);

import 'dart:convert';

AllFlightVendorModel allFlightVendorModelFromJson(String str) =>
    AllFlightVendorModel.fromJson(json.decode(str));

String allFlightVendorModelToJson(AllFlightVendorModel data) =>
    json.encode(data.toJson());

class AllFlightVendorModel {
  String? message;
  List<FDatum>? data;

  AllFlightVendorModel({
    this.message,
    this.data,
  });

  factory AllFlightVendorModel.fromJson(Map<String, dynamic> json) =>
      AllFlightVendorModel(
        message: json["message"],
        data: json["data"] == null
            ? []
            : List<FDatum>.from(json["data"]!.map((x) => FDatum.fromJson(x))),
      );
...
class FDatum {
  ...
  factory FDatum.fromJson(Map<String, dynamic> json) => FDatum(
        ...
        airportForm: json["airport_form"] == null
            ? null
            : Air.fromJson(json["airport_form"]),
        airportTo: json["airport_to"] == null
            ? null
            : Air.fromJson(json["airport_to"]),
        ...
        flightseaturl: json["flight_seat_url"],
      );
