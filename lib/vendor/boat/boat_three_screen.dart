...
import 'package:moonbnd/vendor/boat/boat_four_screen.dart';
...
class BoatPricingScreen extends StatefulWidget {
  const BoatPricingScreen({super.key});

  @override
  BoatPricingScreenState createState() => BoatPricingScreenState();
}

class BoatPricingScreenState extends State<BoatPricingScreen> {
            ...
            child: ListView(
              ...
              children: [
                ...
                CustomTextField(
                  ...
                  // validator: (value) {
                  //   if (value == null || value.isEmpty) {
                  //     return "Please add Minimum advance reservations"; // Validation message
                  //   }
                  //   return null; // Return null if validation passes
                  // },
                  inputFormatters: [FilteringTextInputFormatter.digitsOnly],
                ...
                TertiaryButton(
                  press: () {
                    ...
                    if (_formKey.currentState!.validate()) {
                      ...
                      // if (provider.startTimeController.text.isEmpty) {
                      //   EasyLoading.showToast('Please select start time',
                      ...
                      //   EasyLoading.showToast('Please select end time',
                      //       maskType: EasyLoadingMaskType.black);

                      //   return;
                      // }

                      if (provider.enableExtraPrice == true &&
                          provider.extraPriceBoatVendorList.isEmpty) {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => BoatFourScreen(),
                        ),
                      );
                    }
