...
import 'package:moonbnd/vendor/hotel/edit/edit_hotel_three_screen.dart';
...
class EditHotelLocationScreenState extends StatefulWidget {
  String title = "";
  String content = "";
  String spaceId = "";
...
class _SpaceLocationScreenState extends State<EditHotelLocationScreenState> {
  ...
  void update() {
    ...
    locationid = "${spaceProvider.hotellistdetails?.data?[0].location?.id}";
    addresscontroller = TextEditingController(
        text: spaceProvider.hotellistdetails?.data?[0].address);
    latitude = TextEditingController(
        text: "${spaceProvider.hotellistdetails?.data?[0].mapLat}");
    longitude = TextEditingController(
        text: "${spaceProvider.hotellistdetails?.data?[0].mapLng}");

    zoom = TextEditingController(
        text: "${spaceProvider.hotellistdetails?.data?[0].mapZoom}");

    _updateMarker(LatLng(
        double.parse(spaceProvider.hotellistdetails?.data?[0].mapLat ?? ""),
        double.parse(spaceProvider.hotellistdetails?.data?[0].mapLng ?? "")));
    spaceProvider.hotellistdetails?.data?[0].surrounding?["3"]
        ?.forEach((element) {
      transportationList.add(EducationClass(
    ...
    spaceProvider.hotellistdetails?.data?[0].surrounding?["2"]
        ?.forEach((element) {
      healthList.add(EducationClass(
        name: TextEditingController(text: element.name),
        content: TextEditingController(text: element.content),
    ...
    spaceProvider.hotellistdetails?.data?[0].surrounding?["1"]
        ?.forEach((element) {
      educationList.add(EducationClass(
        name: TextEditingController(text: element.name),
        content: TextEditingController(text: element.content),
        ...
        child: ListView(
          ...
          children: [
            ...
            CustomTextField(
              ...
              validator: (value) {
                if (value == null || value.isEmpty) {
                  return 'Please enter your zoom'.tr;
                }
                return null;
              },
            ),
                  ...
                  SizedBox(
                    ...
                    child: Padding(
                      ...
                      child: DropdownButtonFormField<String>(
                        ...
                        items: ['m'.tr, 'km'.tr].map((String value) {
                          return DropdownMenuItem<String>(
                            value: value,
                            child: Text(value),
                          );
              ...
              press: () async {
                if (_formKey.currentState!.validate()) {
                  ...
                  if (addresscontroller.value.text.isEmpty) {
                    showErrorToast("Please write real address");
                    return;
                  }
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => EditHotelPricingScreen(
