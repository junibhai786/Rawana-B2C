...
import 'package:moonbnd/vendor/event/event_four_screen.dart';
...
class AddEventPricingScreenThree extends StatefulWidget {
  String title = "";
  String content = "";
...
class AddSpacePricingScreenState extends State<AddEventPricingScreenThree> {
  ...
  void addEvent() {
    Provider.of<EventProvider>(context, listen: false)
        .ticketsVendorList
        .add(TicketsVendorModal(
          id: DateTime.now(),
          ticketCode: TextEditingController(),
          nameEgyptian: TextEditingController(),
          nameEnglish: TextEditingController(),
          nameJapnese: TextEditingController(),
              ...
              children: [
                ...
                Padding(
                  ...
                  child: DropdownButtonFormField<String>(
                    value: eventProvider.defaultState,
                    ...
                    onChanged: (value) {
                      eventProvider.defaultState = value.toString();
                      if (value == "Always available") {
                        eventProvider.defaultStateInput = "0";
                      } else if (value == "Only available on specific dates") {
                        eventProvider.defaultStateInput = "1";
                      }
                      setState(() {});
                    },
                  ),
                ...
                // Event Price Input
                CustomTextField(
                  controller: eventProvider.priceController,
                  validator: (value) {
                ...
                // Sale Price Input
                CustomTextField(
                  controller: eventProvider.salePriceController,
                ...
                ListView.builder(
                  ...
                  itemCount: eventProvider.ticketsVendorList.length,
                  itemBuilder: (context, index) {
                    return Column(
                      ...
                      children: [
                        ...
                        CustomTextField(
                          controller:
                              eventProvider.ticketsVendorList[index].ticketCode,
                        ...
                        CustomTextField(
                          controller: eventProvider
                              .ticketsVendorList[index].nameEnglish,
                          hintText: 'English Name'.tr,
                        ),
                        CustomTextField(
                          controller: eventProvider
                              .ticketsVendorList[index].nameJapnese,
                          hintText: 'Japanese Name'.tr,
                        ),
                        CustomTextField(
                          controller: eventProvider
                              .ticketsVendorList[index].nameEgyptian,
                        ...
                        CustomTextField(
                          controller:
                              eventProvider.ticketsVendorList[index].price,
                        ...
                        CustomTextField(
                          controller: eventProvider
                              .ticketsVendorList[index].numberTicket,
                        ...
                        Container(
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              if (eventProvider.ticketsVendorList[index].id !=
                                  null) {
                                deleteTickets(
                                    eventProvider.ticketsVendorList[index].id!);
                              }
                              setState(() {});
                            },
                          ),
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      Checkbox(
                        value: eventProvider.termsAccepted,
                        onChanged: (bool? value) {
                          setState(() {
                            eventProvider.termsAccepted = value!;
                          });
                        },
                      ),
                ...
                if (eventProvider.termsAccepted)
                  ListView.builder(
                    shrinkWrap: true,
                    physics: NeverScrollableScrollPhysics(),
                    itemCount: eventProvider.extraPriceSpaceVendorList.length,
                    itemBuilder: (context, index) {
                      return Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          Padding(
                            ...
                            child: DropdownButtonHideUnderline(
                              child: DropdownButtonFormField<String>(
                                ...
                                onChanged: (value) {
                                  eventProvider.extraPriceSpaceVendorList[index]
                                      .type = value;
                                  setState(() {});
                                },
                              ),
                            ...
                            child: IconButton(
                              ...
                              onPressed: () {
                                if (eventProvider
                                    ...
                                    null) {
                                  deleteExtraPrice(eventProvider
                                      .extraPriceSpaceVendorList[index].id!);
                                }
                                setState(() {});
                              },
                ...
                TertiaryButton(
                  press: () async {
                    if (_formKey.currentState!.validate()) {
                      ...
                      if (eventProvider.defaultState.isEmpty) {
                        showErrorToast("Please enter state".tr);
                        return;
                      }

                      if (eventProvider.termsAccepted == true &&
                          eventProvider.extraPriceSpaceVendorList.isEmpty) {
                        showErrorToast(
                            "Please enter atleast one extra price".tr);
                        return;
                      }
                      if (eventProvider.ticketsVendorList.isEmpty) {
                        showErrorToast("Please enter atleast one Ticket".tr);
                        return;
                      }
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => EventFourVendorScreen(
                                title: widget.title,
                                ...
                                ticketsVendorList:
                                    eventProvider.ticketsVendorList,
                                ...
                                defaultState: eventProvider.defaultState,
                                enableExtraPrice: eventProvider.termsAccepted,
                                extraPriceForVendorList:
                                    eventProvider.extraPriceSpaceVendorList,
                                price: eventProvider.priceController.value.text,
                                salePrice: eventProvider
