...
import 'package:moonbnd/vendor/flight/flight_screen_two.dart';
...
class FlightScreenOne extends StatefulWidget {
  const FlightScreenOne({super.key});

  @override
  FlightScreenOneState createState() => FlightScreenOneState();
}

class FlightScreenOneState extends State<FlightScreenOne> {
  ...
  void initState() {
    ...
    setState(() {
      ...
      provider.flightairportfromids = null;
      provider.flightairporttoids = null;
      provider.flightairlineid = null;
      provider.flightairporttoid = null;
      provider.flightairporttoids = null;
      provider.flightairlineids = null;
      provider.clearDateTimes();
      provider.flightairlineid = null;
      provider.selectedFlighttypeIds.clear();
      provider.flightairportfromid = null;
                ...
                child: Padding(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      ...
                      hint: Text('Select Airport From'.tr),
              ...
              press: () {
                ...
                if (_formKey.currentState!.validate()) {
                  ...
                  if (provider.flightairporttoid == null) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                          content: Text('Please select arrival airport'.tr)),
                    );
                    return;
                  }
                  ...
                  if (provider.selectedDepartureDateTime == null) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                          content: Text('Please select departure time'.tr)),
                    );
                    return;
                  }
                  ...
                  // Navigate to next screen if all validations pass
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => FlightScreenTwo()),
                  );
                }
              },
              text: 'Save & Next'.tr,
