...
import 'package:moonbnd/screens/event/event_booking_confirmation_screen.dart';
...
class BookingScreenForEvent extends StatefulWidget {
...
class _BookingScreenState extends State<BookingScreenForEvent> {
  DateTime? startDate;
  DateTime? endDate;
        ...
        if (homeProvider.paymentMethod == "online") {
          ...
          if (urlGo.contains("https://rawana.com/api/booking/confirm")) {
            await Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => BookingConfirmedScreenForEvent(
                    bookingCode: widget.bookingCode,
                    txpersonTypes: widget.txpersonTypes),
              ),
            );
          }
        } else {
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Spacer(),
                Text(
                    "\$${carbookingitem.bookingResponse?.data?.booking?.service?.salePrice == 0 ? carbookingitem.bookingResponse?.data?.booking?.service?.price : carbookingitem.bookingResponse?.data?.booking?.service?.salePrice}",
                    style:GoogleFonts.spaceGrotesk(
                        fontWeight: FontWeight.w400,
                        fontSize: 16,
                        color: Colors.black54
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items: (carbookingitem.countryResponse?.data?.isNotEmpty ?? false)
