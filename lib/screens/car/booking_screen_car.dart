...
import 'package:moonbnd/screens/car/booking_confirm_car_screen.dart';
...
class BookingScreenForCar extends StatefulWidget {
...
class _BookingScreenState extends State<BookingScreenForCar> {
  DateTime? startDate;
  DateTime? endDate;
            ...
            (value) {
              ...
              if (value.contains("https://rawana.com/api/booking/confirm/")) {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => BookingConfirmedScreenForCar(
  ...
  Widget build(BuildContext context) {
    ...
    log("${carbookingitem.countries} countryes");
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text(
              carbookingitem.bookingResponse?.data?.booking?.service?.title ??
                  "",
                style: GoogleFonts.spaceGrotesk(fontWeight: FontWeight.w500,color: Colors.black,fontSize: 16)
            ),
            SizedBox(height: 10),
            Text(
              carbookingitem.bookingResponse?.data?.booking?.service?.address ??
                  "",
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  (() {
                    final startDate = DateTime.parse(carbookingitem
                            .bookingResponse?.data?.booking?.startDate ??
                        '');
                    final endDate = DateTime.parse(carbookingitem
                            .bookingResponse?.data?.booking?.endDate ??
                        '');
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text('Number Of Passenger'.tr,
                    style:GoogleFonts.spaceGrotesk(
                      fontWeight: FontWeight.w600,
                      fontSize: 16,

                    )),
                Text("${carbookingitem.bookingResponse?.data?.booking?.number}",
                    style:GoogleFonts.spaceGrotesk(
                        fontWeight: FontWeight.w400,
                        fontSize: 16,
                        color: Colors.black54
            ...
            Row(
              children: [
                ...
                Spacer(),
                Text(
                    "\$${(carbookingitem.bookingResponse?.data?.booking?.service?.salePrice == 0 ? carbookingitem.bookingResponse?.data?.booking?.service?.price : carbookingitem.bookingResponse?.data?.booking?.service?.salePrice) * (txdaysDifference + 1)}",
                    style:GoogleFonts.spaceGrotesk(
                        fontWeight: FontWeight.w400,
                        fontSize: 16,
                        color: Colors.black54
            ...
            ...(carbookingitem.bookingResponse?.data?.booking?.extraPrice)!
                .map((element) {
              return Container(
                padding: EdgeInsets.only(top: 10),
                child: Row(
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      if (_isCouponApplied) {
                        ...
                        bool check = await hotelbookingitem.applyCoupon(
                          hotelbookingitem
                                  .bookingResponse?.data?.booking?.code ??
                              '',
                          _couponCodeController.text,
                    ...
                    child: Text(_isCouponApplied ? 'Remove'.tr : 'Apply'.tr),
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items: carbookingitem.countryResponse!.data.isNotEmpty
                        ? carbookingitem.countryResponse!.data.map((country) {
